...
#Training 
#x_train , y_train jeu de donnéées d'entrainement 55 000 images x_validation, y_validation jeu de données : tester d'une iteration à une autre au cours de construction
