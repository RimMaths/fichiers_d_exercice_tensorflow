...
ressults = model.fit((x_train_scaled , x_train_2, x_train_3), y_train, epochs=40,\
                    validation_data=((x_validation_scaled, x_validation_2, x_validation_3), y_validation))

res_eval = model.evaluate((x_test_scaled, x_test_2, x_test_3), y_test)
